...
#define GEM_FONT_CUSTOM    &font04B_038pt7b
...
class GEM_adafruit_gfx {
  public:
    ...
    */
    GEM_adafruit_gfx(Adafruit_SSD1306& agfx_, byte menuPointerType_ = GEM_POINTER_ROW, byte menuItemsPerScreen_ = 5, byte menuItemHeight_ = 10, byte menuPageScreenTopOffset_ = 10, byte menuValuesLeftOffset_ = 86);
  ...
  private:
    ...
    uint16_t _menuForegroundColor = 1;
    uint16_t _menuBackgroundColor = 0;
