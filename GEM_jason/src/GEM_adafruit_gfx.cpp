...
GEM_adafruit_gfx::GEM_adafruit_gfx(Adafruit_SSD1306& agfx_, byte menuPointerType_, byte menuItemsPerScreen_, byte menuItemHeight_, byte menuPageScreenTopOffset_, byte menuValuesLeftOffset_)
  : _agfx(agfx_)
...
void GEM_adafruit_gfx::drawMenu() {
  ...
  _agfx.fillScreen(_menuBackgroundColor);
  _agfx.drawPixel(10, 10, 1);
  _agfx.drawPixel(20, 20, 1);
  _agfx.drawPixel(30, 30, 1);
  _agfx.setTextColor(1);
  // _agfx.setCursor(0, 10); 
  // _agfx.println("Hello, world!");
