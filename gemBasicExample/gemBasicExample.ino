...
// menu stuff....
//(tft, menuPointerType, menuItemsPerScreen, menuItemHeight, menuPageScreenTopOffset, menuValuesLeftOffset
...
GEMItem menuItemSelect("Number2:", selectNumber, menuSelect); 
